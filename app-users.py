...
openai.api_key = "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"
...
st.title('ChatGPT 5.0 🚀')
st.subheader(
    'Now, You Can Generate Images, Generate codes, and Search The Web With ChatGPT 5.0 For Free')
